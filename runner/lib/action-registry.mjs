export const ACTIONS = Object.freeze({
  ...
  press: { target: false, value: true, category: 'interaction' },
  go_back: { target: false, value: false, category: 'navigation' },
  go_forward: { target: false, value: false, category: 'navigation' },
